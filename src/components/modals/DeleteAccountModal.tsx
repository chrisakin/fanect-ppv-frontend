...
/**
 * DeleteAccountModal Component - Confirmation dialog for account deletion
 * 
 * Features:
 * - Warning message about data loss
 * - Async account deletion API call
 * - Loading state with spinner
 * - Auto-logout and redirect to home on success
...
export const DeleteAccountModal = ({ isOpen, onClose }: DeleteAccountModalProps): JSX.Element => {
  /**
   * Loading state while deleting account
   ...
   * Calls DELETE /auth/delete-account, clears tokens, logs out, redirects home
   */
      ...
      <DialogContent className="sm:max-w-[600px] p-0">
        ...
        <Card className="flex flex-col w-full items-center gap-20 relative border-none">
          ...
          <div className="flex items-start justify-center gap-5 self-stretch w-full mb-6 px-6">
            ...
            {/* Delete button - Red destructive style with loading spinner */}
            <Button
              variant="destructive"
